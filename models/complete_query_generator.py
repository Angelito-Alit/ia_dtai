class CompleteQueryGenerator:
    def __init__(self):
        self.query_templates = {
            'all_groups': """
                ...
                WHERE g.activo = 1
                GROUP BY g.id, g.nombre, a.nombre, g.cuatrimestre, g.capacidad_maxima
                ORDER BY g.nombre
            """,
            'student_count': """
            ...
            'final_term_students': """
                ...
                FROM alumnos al
                JOIN carreras c ON al.carrera_id = c.id
                WHERE al.estado_alumno = 'activo' AND al.cuatrimestre_actual = c.duracion_cuatrimestres
            """,
            'students_with_group': """
            ...
            'passed_ordinary_cycle': """
                ...
                WHERE c.ciclo_escolar = %s AND c.estatus = 'aprobado' AND c.tipo_evaluacion = 'ordinario'
            """,
    ...
    def generate_query(self, query_type, parameters):
        ...
        if param_count == 0:
            return template, []
        elif param_count == len(parameters):
    ...
    def format_parameters(self, extracted_data, missing_data):
        ...
        for field, value in extracted_data.items():
            ...
            elif field in ['numero_cuatrimestre', 'numero_capacidad', 'año']:
                try:
